...
const Header = () => {
  return <header className="absolute z-30 w-full flex items-center px-10 xl:px-0 xl:h-[80px]">
    <div className="container mx-auto">
      <div className="flex flex-col lg:flex-row justify-between items-center gap-y-4 py-5 md:py-8">
        {/* logo */}
        <Link href={"/"}>
